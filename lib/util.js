...
exports.reverseHex = function(hex){
    return exports.reverseBuffer(new Buffer.from(String(hex, 'hex'))).toString('hex');
};
...
exports.uint256BufferFromHash = function(hex){
    ...
    var fromHex = new Buffer.from(String(hex, 'hex'));
...
exports.varStringBuffer = function(string){
    var strBuff = new Buffer.from(String(string));
...
exports.pubkeyToScript = function(key){
    ...
    pubkey[0] = 0x21;
    pubkey[34] = 0xac;
    new Buffer.from(String(key, 'hex')).copy(pubkey, 1);
    return pubkey;
};
...
exports.bignumFromBitsHex = function(bitsString){
    var bitsBuff = new Buffer.from(String(bitsString, 'hex'));
