...
var Peer = module.exports = function (options) {
    ...
    var networkServices = new Buffer.from(String('0100000000000000', 'hex')); //NODE_NETWORK services (value 1 packed as uint64)
    var emptyNetAddress = new Buffer.from(String('010000000000000000000000000000000000ffff000000000000', 'hex'));
    var userAgent = util.varStringBuffer('/node-stratum/');
    var blockStartHeight = new Buffer.from(String('00000000', 'hex')); //block start_height, can be empty
