...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    /*
    var emitLog        = function(text) { console.log('Debug: ' + text); };
    var emitWarningLog = function(text) { console.log('Warning: ' + text); };
    var emitErrorLog   = function(text) { console.log('Error: ' + text); };
    var emitSpecialLog = function(text) { console.log('Special: ' + text); };
    */
    ...
    function OnBlockchainSynced(syncedCallback){
        ...
        var checkSynced = function(displayNotSynced){
            _this.daemon.cmd('getblocktemplate', [{"rules": ["segwit"]}], function(results){
    ...
    function SetupJobManager(){
        ...
        _this.jobManager.on('newBlock', function(blockTemplate){
            ...
            var emitShare = function(){
                _this.emit('displayShare', isValidShare, isValidBlock, shareData);
            };
    ...
    function DetectCoinData(finishedCallback){
        ...
        async.waterfall([
            ...
            function(addressInfo, callback){
                var examplePubKey = new Buffer.from([options.coin.addressByte, Buffer.from('010966776006953D5567439E5E39F86A0D273BEE', 'hex')]);
            ...
            function(callback){
                _this.daemon.cmd('getnetworkinfo', [], function(results){
                    ...
                    //Find and return the response with the largest connections (most in-sync)
                    
                    var infoResult = results[0].response;
            ...
            function(callback){
                _this.daemon.cmd('getmininginfo', [], function(results){
                    ...
                    options.initStats.difficulty = miningInfoResult.difficulty;
        ...
        _this.daemon.cmd('getblocktemplate',
            ...
            function(result){
                if (result.error){
                    ...
                    //console.log(options.publicKeyBuffer)
